...
if __name__ == "__main__":
    for n in range(5):
        logger.info("Set up the dict mapping variable names to values")
        t_dict = {}
        ...
        print(t_dict)
        logger.info("call the configs shared state file generator")
        WriteConfigs(
            file_name=r"configs.py",
            source_dict=t_dict,
            primary_keys=["t1", "t2", "t3", "t4"]
        )
        logger.info("import the newly created configs and the variables you created")
        import configs
